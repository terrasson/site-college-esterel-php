...
<head>
    ...
    <title>Administration - Menu Cuisine</title>
...
<body>
    ...
    <div class="admin-container">
        <header class="admin-header">
            <h1>Administration des Menus de la Cuisine</h1>
            <p>Gérez ici les menus de la cuisine (PDF, Word)</p>
        </header>

        <div class="upload-zone" id="uploadZone">
            <input type="file" id="fileInput" accept=".pdf,.doc,.docx" multiple />
            <p>Cliquez ou glissez-déposez vos menus ici</p>
            <p class="accepted-formats">Formats acceptés : PDF, Word</p>
        ...
        <div class="documents-grid" id="documentsGrid">
            <!-- Les menus seront chargés ici dynamiquement -->
        </div>
    </div>
